...
<tr>
	...
	<td class="tbasic"><input type="text" size="10" id="isbn" name="isbn"/></td>
</tr>	
<tr>
	<td class="tbasic"><img src="${root}/img/Indent_squareOrange.gif">도서제목</td>
	<td class="tbasic"><input type="text" size="40" id="title" name="title"/></td>
</tr>	
<tr>
...
<tr>
	...
	<td class="tbasic"><input type="date" size="10" id="pdate" name="publish_date"/></td>
</tr>	
<tr>
...
<tr>
	...
	<td class="tbasic"><input type="text" size="10" id="writer" name="author"/></td>
</tr>	
<tr>
	<td class="tbasic"><img src="${root}/img/Indent_squareGray.gif">도서가격</td>
	<td class="tbasic"><input type="number" size="10" id="price" name="price"/>
...
<tr>
	...
	<td class="tbasic tspacial" >
		<textarea rows="3" cols="50"  id="summary" name="summary"></textarea>
	</td>
</tr>	
<tr><td colspan="2" class="bpadding"> &nbsp;</td></tr>
