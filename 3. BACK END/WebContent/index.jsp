		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form id="joinform" method="post" action="">
					...
					<div><div class="col-lg-6 text-danger"><span>${joinmsg}</span></div></div>
					</c:if>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="container">
					...
					<!-- Modal footer -->
					<div class="modal-footer">
						<button type="button" class="btn btn-danger" id="Update" onclick="javascript:updateMember();">Update</button>
					</div>
				</div>
				</form>
			</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="container">
					...
					<!-- Modal footer -->
					<div class="modal-footer">
						<button type="button" class="btn btn-danger" id="Delete" onclick="javascript:deleteMember();">Delete</button>
					</div>
				</div>
				</form>
			</div>
